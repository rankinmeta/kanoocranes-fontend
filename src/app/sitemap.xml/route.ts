...
export async function GET() {
	const baseUrl =
		process.env.NEXT_PUBLIC_SITE_URL || "https://kanoocranes.com";

	const { categoryRentals, categorySales, models, resources } =
		await loader();
...
async function loader() {
	const [resources, models, categorySales, categoryRentals] =
		await Promise.all([
			getAllResources(),
			getAllModels(),
			getAllCategorySales(),
