...
const UnitCard = ({
  ...
  units: BusinessUnitSectionProps["details"][0][];
}) => {
      ...
      <div className="absolute m-6 grid md:grid-cols-3 gap-2 bottom-0 left-0 right-0 text-white">
        ...
        >
          ...
          <p
            className={cn(
              "text-sm",
              current.id === units[0].image.id ? "block" : "hidden md:block",
            )}
          >
            {units[0].description}
          </p>
        ...
        >
          ...
          <p
            className={cn(
              "text-sm",
              current.id === units[1].image.id ? "block" : "hidden md:block",
            )}
          >
            {units[1].description}
          </p>
        ...
        >
          ...
          <p
            className={cn(
              "text-sm",
              current.id === units[2].image.id ? "block" : "hidden md:block",
            )}
          >
            {units[2].description}
          </p>
