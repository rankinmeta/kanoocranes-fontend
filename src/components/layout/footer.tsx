          ...
          <div className="pt-10">
            ...
            <ul className="flex gap-2 mt-3">
              {socials?.map((social) => (
                <li
                  key={social.id}
                  className="bg-white rounded-full size-12 flex items-center justify-center"
                >
                  <Link
                    href={social.link}
      ...
      <div className="lg:col-span-2 pt-3 lg:pt-20 ps-5 lg:ps-8 pe-5 lg:pe-6 max-w-6xl">
        ...
        <div className="hidden lg:grid grid-cols-4 gap-1">
          <dl className="shrink-0 space-y-2 [&>dd]:text-sm">
            <dt className="font-manrope font-semibold mb-3">
              {quick_links?.title}
            </dt>
          ...
          <dl className="shrink-0 space-y-2">
            <dt className="font-manrope font-semibold mb-3">Contact us</dt>
            <dl className="mb-2 text-sm">
              <dt>Phone</dt>
              <dd>
                <Link
                  href={contact_us?.phone.href}
                  target={contact_us?.phone.isExternal ? "_blank" : "_self"}
                >
            ...
            <dl className="mb-2 text-sm">
              ...
              <dd>
                <Link
                  href={contact_us?.email.href}
                  target={contact_us?.email.isExternal ? "_blank" : "_self"}
                >
            ...
            <dl className="mb-2 text-sm">
              ...
              <dd className="max-w-xs">
                <Link
                  href={contact_us?.address.href}
                  target={contact_us?.address.isExternal ? "_blank" : "_self"}
                >
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3 lg:gap-0 mb-7">
          <span className="text-base lg:text-xs text-[#414651]">
            &copy; {new Date().getFullYear()} Kanoo Cranes. All Rights Reserved
          </span>
          <span className="text-base lg:text-xs text-[#414651]">
            Design by{" "}
            <Link
